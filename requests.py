        ...
        if response.status_code == 200:
            ...
            if csrf_token_input:
                ...
                for name in filenames:
                    ...
                    #print(response.text)
                    # Check if the request was successful                https://emma-back.mse.psych.wsu.edu/csv/zachdod_2023-02-10%2015:14:13
                    if response.status_code == 200:
                        # Parse the HTML content of the page             https://emma-back.mse.psych.wsu.edu/csv/ARtest1_2023-01-31%16:37:22
                        soup = BeautifulSoup(response.text, 'html.parser')
                ...
                print("Data scraping and saving to individual CSV files in 'People' folder completed.")

            else:
                print("CSRF token input element not found.")
        else:
